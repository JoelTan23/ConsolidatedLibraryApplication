...
public class FAQWebView extends Fragment {
    ...
    private static final String URL_TO_LOAD = "https://www.sp.edu.sg/sp/student-services/libfl/about-us/contact-us"; // Change this to your desired URL
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        WebView webView = view.findViewById(R.id.webview_contact);
